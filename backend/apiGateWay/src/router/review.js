...
export const rateProduct = async (req, res) => {
  ...
  console.log("RATE_PRODUCT request received", {
    requestId: req.requestId,
    productId
  })
  ...
  try {
    ...
    appLogger.info({
      requestId: req.requestId,
      event: "RATE_PRODUCT_SUCCESS",
      productId,
      status: response.status
    })

    console.log("RATE_PRODUCT response sent", {
      requestId: req.requestId,
      status: response.status
    })
    ...
    console.error("RATE_PRODUCT error", {
      requestId: req.requestId,
      productId,
      message: error.message
    })
